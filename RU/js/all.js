...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["DPA","О системе","4.4","Архитектура системы","Роли и процессы","Поддерживаемые СУБД","Поддерживаемые ОС","Сеть и маршрутизация","Варианты развертывания","Установка","Обновление компонентов: DPA Server и DPA Host","Перенос компонентов системы на другой сервер ","Администрирование","Интеграция","Сценарии использования","DEMO","Промышленная эксплуатация","Масштабирование","Подготовка сервера к установке","Установка DPA","Установка DPA Server ","Первый запуск и авторизация","Настройки безопасности","Настройка хранения данных","Возможные проблемы","Настройка интеграции","Базовый мониторинг","Классификация простоев","Контроль загрузки оборудования","Работа с управляющими программами","Технология","Сменно-суточные задания","Оператор","Диспетчерский пульт и уведомления","DEMO. Настройка системы с предустановленными данным","Настройка мониторинга","Настройки системы","Структура предприятия","Конфигурирование печатных форм и форм уведомлений","Пользователи. Создание, редактирование и удаление учетной записи пользователя","Группы. Создание, редактирование и удаление группы доступа","Настройка прав доступа","Действия пользователей","Индикаторы","Очистка журналов","Общая диагностика","Сервер","Драйвер","Справочники","Аналитика","Журналы","Справочники","Аналитика","Аналитика","Настройка приборных панелей","Справочники","Аналитика","Сигналы","Добавление сервера и транспорта","Получение лицензии","Подключение и настройка драйвера","Устройства вибромониторинга ","Загрузка установочных компонентов системы","Рабочее время","Безопасность","3D–модели оборудования","Группы рабочих центров","Шаблоны отчетов Excel","Настройка приборных панелей","Настройка отправки веб-уведомлений","Настройка отправки электронной почты","Настройка отправки СМС","Счетчики производительности","Журналы","Совместимость","Диагностика","Счетчики производительности","Снижение нагрузки","Журналы","Агент","Создание драйвера","Обновление конфигурации и настроек логирования драйвера"],
    DREX_NODE_LINKS: ["index.htm","o_sisteme.htm","4_4.htm","arkhitektura_sistemy.htm","roli_i_protsessy.htm","podderzhivaemye_subd.htm","podderzhivaemye_os.htm","set_i_marshrutizatsiya.htm","varianty_razvertyvaniya.htm","ustanovka.htm","obnovlenie_komponentov__dpa_server_i_dpa_host.htm","perenos_komponentov_sistemy_na_drugoj_server_.htm","administrirovanie.htm","integratsiya.htm","stsenarii_ispolzovaniya.htm","demo.htm","promyshlennaya_ehkspluatatsiya.htm","masshtabirovanie.htm","podgotovka_servera_k_ustanovke.htm","ustanovka_dpa.htm","ustanovka_dpa_server_.htm","pervyj_zapusk_i_avtorizatsiya.htm","nastrojki_bezopasnosti.htm","nastrojka_khraneniya_dannykh.htm","vozmozhnye_problemy.htm","nastrojka_integratsii.htm","bazovyj_monitoring.htm","klassifikatsiya_prostoev.htm","kontrol_zagruzki_oborudovaniya.htm","rabota_s_upravlyayushchimi_programmami.htm","tekhnologiya.htm","smenno_sutochnye_zadaniya.htm","operator.htm","dispetcherskij_pult_i_uvedomleniya.htm","demo__nastrojka_sistemy_s_predustanovlennymi_dannym.htm","nastrojka_monitoringa.htm","nastrojki_sistemy.htm","struktura_predpriyatiya.htm","konfigurirovanie_pechatnykh_form_i_form_uvedomlenij.htm","polzovateli__sozdanie__redaktirovanie_i_udalenie_uchetnoj_zapisi_polzovatelya.htm","gruppy__sozdanie__redaktirovanie_i_udalenie_gruppy_dostupa.htm","nastrojka_prav_dostupa.htm","dejstviya_polzovatelej.htm","indikatory.htm","ochistka_zhurnalov.htm","obshchaya_diagnostika.htm","server.htm","drajver.htm","spravochniki_1.htm","analitika_1.htm","zhurnaly_3.htm","spravochniki_2.htm","analitika_2.htm","analitika_3.htm","nastrojka_pribornykh_panelej_2.htm","spravochniki_3.htm","analitika_4.htm","signaly.htm","dobavlenie_servera_i_transporta.htm","poluchenie_litsenzii.htm","podklyuchenie_i_nastrojka_drajvera.htm","ustrojstva_vibromonitoringa_.htm","zagruzka_ustanovochnykh_komponentov_sistemy.htm","rabochee_vremya.htm","bezopasnost.htm","3d_modeli_oborudovaniya.htm","gruppy_rabochikh_tsentrov.htm","shablony_otchetov_excel.htm","nastrojka_pribornykh_panelej_1.htm","nastrojka_otpravki_veb_uvedomlenij.htm","nastrojka_otpravki_ehlektronnoj_pochty.htm","nastrojka_otpravki_sms.htm","schetchiki_proizvoditelnosti_1.htm","zhurnaly_1.htm","sovmestimost.htm","diagnostika.htm","schetchiki_proizvoditelnosti_2.htm","snizhenie_nagruzki.htm","zhurnaly_2.htm","agent.htm","sozdanie_drajvera.htm","obnovlenie_konfiguratsii_i_nastroek_logirovaniya_drajvera.htm"],
    DREX_NODE_CHILD_START: [1,3,9,15,15,15,15,15,15,18,21,21,21,25,26,34,34,34,34,34,34,34,39,43,45,48,48,51,53,55,55,55,55,56,58,58,63,63,67,72,72,72,72,72,72,72,72,76,80,80,80,80,80,80,80,80,80,80,80,80,80,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82],
    DREX_NODE_CHILD_END: [3,9,15,15,15,15,15,15,18,21,21,21,25,26,34,34,34,34,34,34,34,39,43,45,48,48,51,53,55,55,55,55,56,58,58,63,63,67,72,72,72,72,72,72,72,72,76,80,80,80,80,80,80,80,80,80,80,80,80,80,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82],
    DREX_MENU_TYPE: 3,
