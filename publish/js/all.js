...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["DPA","4.4","Установка","Администрирование","Конфигурация модели предпрития","Интеграция","Использование","Системные требования","Установка DPA-Сервера ","Установка DPA-Host ","Возможные проблемы","Первый запуск и авторизация","Настройки системы","Настройки безопасности","Настройка хранения данных","Возможные проблемы","Структура предприятия","Справочники","Настройка интеграции","Главная страница","Просмотр данных","Пользовательские настройки","АРМ специалистов","Журналы","Аналитика","Отчеты","Приборные панели","Сигналы ","Загрузчик УП","Технология","Заказы","Оператор","Диспетчеризация","ТОиР","Простои и недоступность"],
    DREX_NODE_LINKS: ["index.htm","4_4.htm","ustanovka.htm","administrirovanie.htm","konfiguratsiya_modeli_predpritiya.htm","integratsiya.htm","ispolzovanie.htm","sistemnye_trebovaniya.htm","ustanovka_dpa_servera_.htm","ustanovka_dpa_host_.htm","vozmozhnye_problemy_1.htm","pervyj_zapusk_i_avtorizatsiya.htm","nastrojki_sistemy.htm","nastrojki_bezopasnosti.htm","nastrojka_khraneniya_dannykh.htm","vozmozhnye_problemy_2.htm","struktura_predpriyatiya.htm","spravochniki.htm","nastrojka_integratsii.htm","glavnaya_stranitsa.htm","prosmotr_dannykh.htm","polzovatelskie_nastrojki.htm","arm_spetsialistov.htm","zhurnaly.htm","analitika.htm","otchety.htm","pribornye_paneli.htm","signaly_.htm","zagruzchik_up.htm","tekhnologiya.htm","zakazy.htm","operator.htm","dispetcherizatsiya.htm","toir.htm","prostoi_i_nedostupnost.htm"],
    DREX_NODE_CHILD_START: [1,2,7,11,16,18,19,23,23,23,23,23,23,23,23,23,23,23,23,23,23,26,28,35,35,35,35,35,35,35,35,35,35,35,35],
    DREX_NODE_CHILD_END: [2,7,11,16,18,19,23,23,23,23,23,23,23,23,23,23,23,23,23,23,26,28,35,35,35,35,35,35,35,35,35,35,35,35,35],
    DREX_MENU_TYPE: 3,
