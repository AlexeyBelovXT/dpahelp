...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["DPA","About DPA","Installation","Administration","Интеграция со сторонними системами","Сценарии использования","System structure","Roles and Tasks","Supported DBMS","Supported OS","Network and Routing","Installation options","Before installation","Installation DPA","Installation DPA Server ","Update DPA","Move components to other server","First of all","Basic settings","Security. Users, groups, permissions","Структура предприятия","Настройка печатных форм и форм уведомлений","Настройка хранения данных","Наблюдение. Диагностика. Устранение неисправностей","Демонстрационный режим. Настройка системы с предустановленными данным","Справочники","Основные принципы","Состав и тип данных","Настройка интеграции","REST API","Настройка приборных панелей","Оператор","Диспетчер","Технолог","Мастер","All-in-one","Recommended installation","Adding DPA server and transport","Licensing","Connection and setup of the driver","Vibromonitoring adding","Installation files","System Settings","Groups settings","Users settings","Access rights","Set secure connection. Https","Рабочее время","Безопасность","3D–модели оборудования","Группы рабочих центров","Импорт конфигурации оборудования","Шаблоны отчетов Excel","Настройка приборных панелей","Настройка отправки веб-уведомлений","Настройка отправки электронной почты","Настройка отправки СМС","Индикаторы","Очистка журналов","Ошибки запуска","Сервер","Драйвер","Действия пользователей","Причины простоя","Смены","Классификация простоев","Базовый мониторинг","Аналитика","Сигналы","Сменно-суточные задания","Журналы","Управляющие программы (УП)","Технология","Контроль загрузки оборудования","Аналитика простоев","Driver Creation","Update Driver","Счетчики производительности","Журналы","Совместимость","Диагностика","Счетчики производительности","Снижение нагрузки","Журналы","Агент","Аналитика","Контроль УП","Библиотека УП","Загрузка УП","Верификация и нормирование","Аналитика. Отчёты. Журналы","Работа со справочниками","Интеграция"],
    DREX_NODE_LINKS: ["index.htm","about_dpa.htm","installation.htm","administration.htm","integratsiya_so_storonnimi_sistemami.htm","stsenarii_ispolzovaniya.htm","system_structure.htm","roles_and_tasks.htm","supported_dbms.htm","supported_os.htm","network_and_routing.htm","installation_options.htm","before_installation.htm","installation_dpa.htm","installation_dpa_server_.htm","update_dpa.htm","move_components_to_other_server.htm","first_of_all.htm","basic_settings.htm","security__users__groups__permissions.htm","struktura_predpriyatiya.htm","nastrojka_pechatnykh_form_i_form_uvedomlenij.htm","nastrojka_khraneniya_dannykh.htm","nablyudenie__diagnostika__ustranenie_neispravnostej.htm","demonstratsionnyj_rezhim__nastrojka_sistemy_s_predustanovlennymi_dannym.htm","spravochniki.htm","osnovnye_printsipy.htm","sostav_i_tip_dannykh.htm","nastrojka_integratsii.htm","rest_api.htm","nastrojka_pribornykh_panelej_2.htm","operator.htm","dispetcher.htm","tekhnolog.htm","master.htm","all_in_one.htm","recommended_installation.htm","adding_dpa_server_and_transport.htm","licensing.htm","connection_and_setup_of_the_driver.htm","vibromonitoring_adding.htm","installation_files.htm","system_settings.htm","groups_settings.htm","users_settings.htm","access_rights.htm","set_secure_connection__https.htm","rabochee_vremya.htm","bezopasnost.htm","3d_modeli_oborudovaniya.htm","gruppy_rabochikh_tsentrov.htm","import_konfiguratsii_oborudovaniya.htm","shablony_otchetov_excel.htm","nastrojka_pribornykh_panelej_1.htm","nastrojka_otpravki_veb_uvedomlenij.htm","nastrojka_otpravki_ehlektronnoj_pochty.htm","nastrojka_otpravki_sms.htm","indikatory.htm","ochistka_zhurnalov.htm","oshibki_zapuska.htm","server.htm","drajver.htm","dejstviya_polzovatelej.htm","prichiny_prostoya.htm","smeny.htm","klassifikatsiya_prostoev.htm","bazovyj_monitoring.htm","analitika_2.htm","signaly.htm","smenno_sutochnye_zadaniya.htm","zhurnaly_3.htm","upravlyayushchie_programmy__up_.htm","tekhnologiya.htm","kontrol_zagruzki_oborudovaniya.htm","analitika_prostoev.htm","driver_creation.htm","update_driver.htm","schetchiki_proizvoditelnosti_1.htm","zhurnaly_1.htm","sovmestimost.htm","diagnostika.htm","schetchiki_proizvoditelnosti_2.htm","snizhenie_nagruzki.htm","zhurnaly_2.htm","agent.htm","analitika_1.htm","kontrol_up.htm","biblioteka_up.htm","zagruzka_up.htm","verifikatsiya_i_normirovanie.htm","analitika__otchyety__zhurnaly.htm","rabota_so_spravochnikami.htm","integratsiya.htm"],
