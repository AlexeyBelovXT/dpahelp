...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["DPA","О системе","4.4","Архитектура системы","Варианты развертывания","Поддерживаемые СУБД","Установка","Администрирование","Базовая настройка","Интеграция","Сценарии использования","DEMO","Малые проекты","Крупные проекты и масштабирование","Подготовка сервера к установке","Установка DPA-Сервера ","Установка DPA-Host ","Возможные проблемы","Первый запуск и авторизация","Настройки системы","Настройки безопасности","Настройка хранения данных","Возможные проблемы","Структура предприятия","Безопасность","Настройки системы","Настройка интеграции","Базовый мониторинг","Контроль загрузки оборудования","Сигналы","Классификация простоев","Работа с управляющими программами","Технология","Сменно-суточные задания","Оператор","Диспетчерский пульт","Индикаторы","Очистка журналов","Общая диагностика","Логи","Сервер","Драйверы","Диагностика","Счетчики производительности","Счетчики производительности","Снижение нагрузки"],
    DREX_NODE_LINKS: ["index.htm","o_sisteme.htm","4_4.htm","arkhitektura_sistemy.htm","varianty_razvertyvaniya.htm","podderzhivaemye_subd.htm","ustanovka.htm","administrirovanie.htm","bazovaya_nastrojka.htm","integratsiya.htm","stsenarii_ispolzovaniya.htm","demo.htm","malye_proekty.htm","krupnye_proekty_i_masshtabirovanie.htm","podgotovka_servera_k_ustanovke.htm","ustanovka_dpa_servera_.htm","ustanovka_dpa_host_.htm","vozmozhnye_problemy_1.htm","pervyj_zapusk_i_avtorizatsiya.htm","nastrojki_sistemy_1.htm","nastrojki_bezopasnosti.htm","nastrojka_khraneniya_dannykh.htm","vozmozhnye_problemy_2.htm","struktura_predpriyatiya.htm","bezopasnost.htm","nastrojki_sistemy_2.htm","nastrojka_integratsii.htm","bazovyj_monitoring.htm","kontrol_zagruzki_oborudovaniya.htm","signaly.htm","klassifikatsiya_prostoev.htm","rabota_s_upravlyayushchimi_programmami.htm","tekhnologiya.htm","smenno_sutochnye_zadaniya.htm","operator.htm","dispetcherskij_pult.htm","indikatory.htm","ochistka_zhurnalov.htm","obshchaya_diagnostika.htm","logi.htm","server.htm","drajvery.htm","diagnostika.htm","schetchiki_proizvoditelnosti_1.htm","schetchiki_proizvoditelnosti_2.htm","snizhenie_nagruzki.htm"],
    DREX_NODE_CHILD_START: [1,3,6,11,11,14,14,18,23,26,27,36,36,36,36,36,36,36,36,36,36,36,38,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,44,46,46,46,46],
    DREX_NODE_CHILD_END: [3,6,11,11,14,14,18,23,26,27,36,36,36,36,36,36,36,36,36,36,36,38,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,42,44,46,46,46,46,46],
    DREX_MENU_TYPE: 3,
