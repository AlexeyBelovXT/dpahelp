...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["DPA","About DPA","Installation","Administration","integration with other systems","System structure","Roles and Tasks","Supported DBMS","Supported OS","Network and Routing","Installation options","Before installation","Installation DPA","Installation DPA Server ","Update DPA","Move components to other server","Basic settings","Setup of printing forms and forms of notifications","Settings for data storage","Monitoring. Diagnostics. Troubleshooting","Basic principles of interaction of systems.","Structure and data type.","Setup of integration","REST API","All-in-one","Recommended installation","Adding DPA server and transport","Licensing","Security. Users, groups, permissions","Enterprise structure","Connection and setup of the driver","Vibromonitoring adding","Installation files","System Settings","Excel Reports templates. Import","Dashboard settings","Web-notifications","Email","SMS","Indicators","Clear database","Start errors","Server","Driver","Users actions","Groups settings","Users settings","Access rights","Set secure connection. Https","Working time","Security","Import Enterprise Structure","Driver Creation","Update Driver","Performance counters","Logs","Compatibility","Diagnostics","Performance counters","Decrease loading","Logs","Agent"],
    DREX_NODE_LINKS: ["index.htm","about_dpa.htm","installation.htm","administration.htm","integration_with_other_systems.htm","system_structure.htm","roles_and_tasks.htm","supported_dbms.htm","supported_os.htm","network_and_routing.htm","installation_options.htm","before_installation.htm","installation_dpa.htm","installation_dpa_server_.htm","update_dpa.htm","move_components_to_other_server.htm","basic_settings.htm","setup_of_printing_forms_and_forms_of_notifications.htm","settings_for_data_storage.htm","monitoring__diagnostics__troubleshooting.htm","basic_principles_of_interaction_of_systems_.htm","structure_and_data_type_.htm","setup_of_integration.htm","rest_api.htm","all_in_one.htm","recommended_installation.htm","adding_dpa_server_and_transport.htm","licensing.htm","security__users__groups__permissions.htm","enterprise_structure.htm","connection_and_setup_of_the_driver.htm","vibromonitoring_adding.htm","installation_files.htm","system_settings.htm","excel_reports_templates__import.htm","dashboard_settings.htm","web_notifications.htm","email.htm","sms.htm","indicators.htm","clear_database.htm","start_errors.htm","server.htm","driver.htm","users_actions.htm","groups_settings.htm","users_settings.htm","access_rights.htm","set_secure_connection__https.htm","working_time.htm","security.htm","import_enterprise_structure.htm","driver_creation.htm","update_driver.htm","performance_counters_1.htm","logs_1.htm","compatibility.htm","diagnostics.htm","performance_counters_2.htm","decrease_loading.htm","logs_2.htm","agent.htm"],
    DREX_NODE_CHILD_START: [1,5,11,16,20,24,24,24,24,24,24,26,26,26,26,26,26,34,39,41,45,45,45,45,45,45,45,45,45,49,52,54,54,54,54,54,54,54,54,54,54,54,54,58,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62],
    DREX_NODE_CHILD_END: [5,11,16,20,24,24,24,24,24,24,26,26,26,26,26,26,34,39,41,45,45,45,45,45,45,45,45,45,49,52,54,54,54,54,54,54,54,54,54,54,54,54,58,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62,62],
    DREX_MENU_TYPE: 2,
...
DR_EXPLAIN.data_search = {
    ...
    DREXPLAIN_NOT_FOUND: "",
    DREXPLAIN_EMPTY_STRING: "",
    DREXPLAIN_IN_PROGRESS: "",
