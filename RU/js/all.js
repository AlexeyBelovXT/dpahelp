...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["DPA","О системе","4.4","Архитектура системы","Варианты развертывания","Поддерживаемые СУБД","Установка","Обновление компонентов: DPA Server и DPA Host","Обновление конфигурации и настроек логирования драйвера","Перенос компонентов системы на другой сервер ","Администрирование","Базовая настройка","Интеграция","Сценарии использования","DEMO","Малые проекты","Крупные проекты и масштабирование","Подготовка сервера к установке","Установка DPA","Установка DPA Server ","Возможные проблемы","Перенос базы данных ","Перенос базы данных и Project109","Перенос Project109","Перенос сервера DPA ","Перенос базы данных, сервера DPA и Project109","Первый запуск и авторизация","Первичная настройка системы","Настройки безопасности","Настройка хранения данных","Возможные проблемы","Структура предприятия","Настройки системы","Настройка интеграции","Базовый мониторинг","Контроль загрузки оборудования","Сигналы","Классификация простоев","Работа с управляющими программами","Технология","Сменно-суточные задания","Оператор","Диспетчерский пульт","Настройка мониторинга","Конфигурирование экранных и отчетных форм","Пользователи. Создание, редактирование и удаление учетной записи пользователя","Группы. Создание, редактирование и удаление группы доступа","Настройка прав доступа","Индикаторы","Очистка журналов","Общая диагностика","Логи","Сервер","Драйверы","Рабочее время","Безопасность","3D–модели оборудования","Группы рабочих центров","Добавление сервера и транспорта","Получение лицензии","Создание драйвера","Обновление конфигурации и настроек логирования драйвера","Устройства вибромониторинга ","Загрузка установочных компонентов системы","Шаблоны отчетов Excel","Настройка приборных панелей","Настройка отправки веб-уведомлений","Настройка отправки электронной почты","Настройка отправки СМС","Диагностика","Счетчики производительности","Счетчики производительности","Снижение нагрузки"],
    DREX_NODE_LINKS: ["index.htm","o_sisteme.htm","4_4.htm","arkhitektura_sistemy.htm","varianty_razvertyvaniya.htm","podderzhivaemye_subd.htm","ustanovka.htm","obnovlenie_komponentov__dpa_server_i_dpa_host.htm","obnovlenie_konfiguratsii_i_nastroek_logirovaniya_drajvera_1.htm","perenos_komponentov_sistemy_na_drugoj_server_.htm","administrirovanie.htm","bazovaya_nastrojka.htm","integratsiya.htm","stsenarii_ispolzovaniya.htm","demo.htm","malye_proekty.htm","krupnye_proekty_i_masshtabirovanie.htm","podgotovka_servera_k_ustanovke.htm","ustanovka_dpa.htm","ustanovka_dpa_server_.htm","vozmozhnye_problemy_1.htm","perenos_bazy_dannykh_.htm","perenos_bazy_dannykh_i_project109.htm","perenos_project109.htm","perenos_servera_dpa_.htm","perenos_bazy_dannykh__servera_dpa_i_project109.htm","pervyj_zapusk_i_avtorizatsiya.htm","pervichnaya_nastrojka_sistemy.htm","nastrojki_bezopasnosti.htm","nastrojka_khraneniya_dannykh.htm","vozmozhnye_problemy_2.htm","struktura_predpriyatiya.htm","nastrojki_sistemy.htm","nastrojka_integratsii.htm","bazovyj_monitoring.htm","kontrol_zagruzki_oborudovaniya.htm","signaly.htm","klassifikatsiya_prostoev.htm","rabota_s_upravlyayushchimi_programmami.htm","tekhnologiya.htm","smenno_sutochnye_zadaniya.htm","operator.htm","dispetcherskij_pult.htm","nastrojka_monitoringa.htm","konfigurirovanie_ehkrannykh_i_otchetnykh_form.htm","polzovateli__sozdanie__redaktirovanie_i_udalenie_uchetnoj_zapisi_polzovatelya.htm","gruppy__sozdanie__redaktirovanie_i_udalenie_gruppy_dostupa.htm","nastrojka_prav_dostupa.htm","indikatory.htm","ochistka_zhurnalov.htm","obshchaya_diagnostika.htm","logi.htm","server.htm","drajvery.htm","rabochee_vremya.htm","bezopasnost.htm","3d_modeli_oborudovaniya.htm","gruppy_rabochikh_tsentrov.htm","dobavlenie_servera_i_transporta.htm","poluchenie_litsenzii.htm","sozdanie_drajvera.htm","obnovlenie_konfiguratsii_i_nastroek_logirovaniya_drajvera_2.htm","ustrojstva_vibromonitoringa_.htm","zagruzka_ustanovochnykh_komponentov_sistemy.htm","shablony_otchetov_excel.htm","nastrojka_pribornykh_panelej.htm","nastrojka_otpravki_veb_uvedomlenij.htm","nastrojka_otpravki_ehlektronnoj_pochty.htm","nastrojka_otpravki_sms.htm","diagnostika.htm","schetchiki_proizvoditelnosti_1.htm","schetchiki_proizvoditelnosti_2.htm","snizhenie_nagruzki.htm"],
    DREX_NODE_CHILD_START: [1,3,6,14,14,17,17,21,21,21,26,31,33,34,43,43,43,43,43,43,43,43,43,43,43,43,43,43,45,48,50,54,58,58,58,58,58,58,58,58,58,58,58,58,64,69,69,69,69,69,69,69,69,71,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73],
    DREX_NODE_CHILD_END: [3,6,14,14,17,17,21,21,21,26,31,33,34,43,43,43,43,43,43,43,43,43,43,43,43,43,43,45,48,50,54,58,58,58,58,58,58,58,58,58,58,58,58,64,69,69,69,69,69,69,69,69,71,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73,73],
    DREX_MENU_TYPE: 3,
